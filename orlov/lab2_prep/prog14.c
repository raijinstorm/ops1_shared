...
// void sethandler(... — helper to install a handler for a given signal.
// struct sigaction act; — action structure.
// memset(&act, 0, ...) — clear all fields.
// act.sa_handler = f; — set handler function.
// sigaction(sigNo, &act, NULL) — install handler.
// On failure → kill whole process group.
// This eliminates repeated boilerplate.
